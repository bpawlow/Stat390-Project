...
train <-
  read_csv("data/train_cleaned.csv") %>%
  select(-x702) %>%
  mutate(x516 = as_factor(x516))
pca_train <-
  read_csv('data/pca_train.csv') %>%
  select(-x702) %>%
 mutate(x516 = as_factor(x516))

folds <- vfold_cv(train, v = 5, repeats = 5, strata = y)
write_rds(folds, 'model selection/model_objects/folds4.rds')
folds <- read_rds('model selection/model_objects/folds4.rds')
folds_pca <- vfold_cv(pca_train, v = 5, repeats = 5, strata = y)
write_rds(folds_pca, 'model selection/model_objects/folds_pca4.rds')
folds_pca <- read_rds('model selection/model_objects/folds_pca4.rds')
...
write_rds(bt_tuned, "model selection/model_objects/bt_tuned4.rds")
bt_tuned<-read_rds("model selection/model_objects/bt_tuned4.rds")
...
bt_grid_pca <- grid_regular(bt_params_pca, levels = 10)
...
write_rds(bt_tuned_pca, "model selection/model_objects/bt_tuned_pca4.rds")
...
write_rds(nn_tuned, "model selection/model_objects/nn_tuned4.rds")
...
nn_grid_pca <- grid_regular(nn_params_pca, levels = 10)
...
write_rds(nn_tuned_pca, "model selection/model_objects/nn_tuned_pca4.rds")
...
cube_grid <- grid_regular(cube_params, levels = 10)
...
write_rds(cube_tuned, "model selection/model_objects/cube_tuned4.rds")
...
cube_grid_pca <- grid_regular(cube_params_pca, levels = 10)
...
write_rds(cube_tuned_pca, "model selection/model_objects/cube_tuned_pca4.rds")
...
bmlp_grid <- grid_regular(bmlp_params, levels = 10) 
...
write_rds(bmlp_tuned, "model selection/model_objects/bmlp_tuned4.rds")
...
bmlp_grid_pca <- grid_regular(bmlp_params_pca, levels = 10) 
...
write_rds(bmlp_tuned_pca, "model selection/model_objects/bmlp_tuned_pca4.rds")
...
write_rds(svm_tuned, "model selection/model_objects/svm_tuned4.rds")
...
svm_grid_pca <- grid_regular(svm_params_pca, levels = 10)
...
write_rds(svm_tuned_pca, "model selection/model_objects/svm_tuned_pca4.rds")
...
svm_fit_pca <- fit(svm_workflow_tuned_pca,pca_train)

svm_predict <- pca_test %>%
  bind_cols(predict(svm_fit_pca, .)) %>%
  select(id,.pred)

prediction65<- svm_predict %>%
  rename(y = .pred) %>%
  mutate(y = exp(y),
         y = y + 1.8,
...
write_csv(prediction65, 'predictions/prediction65.csv')
...
write_rds(knn_tuned, "model selection/model_objects/knn_tuned4.rds")
...
write_rds(knn_tuned_pca, "model selection/model_objects/knn_tuned_pca4.rds")
...
write_rds(rf_tuned, "model selection/model_objects/rf_tuned4.rds")
...
rf_grid_pca <- grid_regular(rf_params_pca, levels = 10)
...
write_rds(rf_tuned_pca, 'model selection/model_objects/rf_tuned_pca4.rds')
...
write_rds(en_tuned, "model selection/model_objects/en_tuned4.rds")
...
en_grid_pca <- grid_regular(en_params_pca, levels = 10)
...
write_rds(en_tuned_pca, "model selection/model_objects/en_tuned_pca4.rds")
...
bag_tree_grid <- grid_regular(bag_tree_params, levels = 10) 
...
write_rds(bag_tree_tuned, "model selection/model_objects/bag_tree_tuned4.rds")
...
bag_tree_grid_pca <- grid_regular(bag_tree_params_pca, levels = 10) 
...
write_rds(bag_tree_tuned_pca, "model selection/model_objects/bag_tree_tuned_pca4.rds")
...
bag_mars_grid <- grid_regular(bag_mars_params, levels = 10) 
...
write_rds(bag_mars_tuned, "model selection/model_objects/bag_mars_tuned4.rds")
...
bag_mars_grid_pca <- grid_regular(bag_mars_params_pca, levels = 10) 
...
write_rds(bag_mars_tuned_pca, "model selection/model_objects/bag_mars_tuned_pca4.rds")
...
write_rds(mars_tuned, "model selection/model_objects/mars_tuned4.rds")
...
mars_grid_pca <- grid_regular(mars_params_pca, levels = 10) 
...
write_rds(mars_tuned_pca, "model selection/model_objects/mars_tuned_pca4.rds")
...
svmpoly_grid <- grid_regular(svmpoly_params, levels = 10)
...
write_rds(svmpoly_tuned, "model selection/model_objects/svmpoly_tuned4.rds")
...
svmpoly_grid_pca <- grid_regular(svmpoly_params_pca, levels = 10)
...
write_rds(svmpoly_tuned_pca, "model selection/model_objects/svmpoly_tuned_pca4.rds")
